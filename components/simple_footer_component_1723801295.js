...
Vue.component("simple_footer_component_1723801295", {
    template: `
    <footer id="footer-section" style="min-height: 430px"   class="flex-1 bg-gradient-to-r from-pink-400 to-purple-600 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg" >
            ...
            <div id="footer-content" class="text-center">
                <div class="flex">
                    <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-6 text-3xl font-bold text-white hover:text-pink-200 transition-colors duration-300">
                        <img id="footer-logo" src="https://makeinfinite-mentat-test.azurewebsites.net/get_image/Hen_Care_Companion_1723801294/logo.svg" alt="Landwind Logo" class="h-8 mr-4 sm:h-10">
                        ChickenChatter's
                    </a>
                </div>
            </div>
